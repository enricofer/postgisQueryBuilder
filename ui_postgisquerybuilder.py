...
class Ui_postgisQueryBuilder(object):
    def setupUi(self, postgisQueryBuilder):
        ...
        postgisQueryBuilder.resize(486, 861)
        ...
        self.queryDefinitionSlot.setGeometry(QtCore.QRect(0, 0, 468, 684))
        ...
        self.verticalLayout_12.addWidget(self.CONDITIONLabel)
        ...
        self.verticalLayout_12.addWidget(self.CONDITION)
