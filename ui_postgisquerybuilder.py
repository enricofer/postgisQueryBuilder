...
#
# Created: Tue Sep 01 17:16:28 2015
...
class Ui_postgisQueryBuilder(object):
    def setupUi(self, postgisQueryBuilder):
        ...
        postgisQueryBuilder.resize(484, 635)
        ...
        self.verticalLayout_20 = QtGui.QVBoxLayout(postgisQueryBuilder)
        ...
        self.ConnectionSlot.setGeometry(QtCore.QRect(0, 0, 466, 437))
        ...
        self.queryTypeSlot.setGeometry(QtCore.QRect(0, 0, 466, 437))
        self.queryTypeSlot.setObjectName(_fromUtf8("queryTypeSlot"))
        self.verticalLayout_18 = QtGui.QVBoxLayout(self.queryTypeSlot)
        ...
        self.Helper2.setMinimumSize(QtCore.QSize(0, 80))
        self.Helper2.setMaximumSize(QtCore.QSize(16777215, 1000000))
        ...
        self.verticalLayout_11.addWidget(self.Helper2)
        self.DiagPanel = QtGui.QGraphicsView(self.queryTypeSlot)
        self.DiagPanel.setMinimumSize(QtCore.QSize(0, 150))
        ...
        self.queryDefinitionSlot.setGeometry(QtCore.QRect(0, 0, 466, 437))
        ...
        self.Helper.setMinimumSize(QtCore.QSize(0, 25))
        ...
        self.verticalLayout_7.addWidget(self.Helper)
        ...
        self.fieldsListA.setMinimumSize(QtCore.QSize(0, 30))
        ...
        self.fieldsListB.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.horizontalLayout_15.addWidget(self.FIELD)
        ...
        self.horizontalLayout_18.addWidget(self.DISTANCEOP)
        ...
        self.horizontalLayout_20.addWidget(self.FIELDb)
        ...
        self.filterRecordSlot.setGeometry(QtCore.QRect(0, 0, 466, 437))
        ...
        self.SqlCodeSlot.setGeometry(QtCore.QRect(0, 0, 466, 437))
        ...
        self.tableResultSlot.setGeometry(QtCore.QRect(0, 0, 466, 437))
        ...
        self.historySlot.setGeometry(QtCore.QRect(0, 0, 466, 437))
    ...
    def retranslateUi(self, postgisQueryBuilder):
        ...
        self.selectAllFields.setText(_translate("postgisQueryBuilder", "Select all fields", None))
